...
export default function Police() {
  return (
    ...
    >
      <Container>
        <Link to="/services" className="inline-flex items-center gap-2 text-blue-700 hover:underline mb-6">
          <ArrowLeft size={18} /> Back to Services
        </Link>

        <h1 className="text-4xl font-poppins font-bold mb-4">Metropolitan Police Service</h1>
        <p className="font-roboto text-lg mb-8">
          The Metropolitan Police Service (MPS) is responsible for keeping London’s streets safe.  
          Join units like **Roads Traffic Policing Command, Specialist Firearms Command, CID, and Response** — experience realistic policing, teamwork,  
