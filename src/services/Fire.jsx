...
import AmbulanceDivisions from "./AmbulanceDivisions.jsx"; // ✅ import your division cards
    ...
    >
      ...
      <Container>
        ...
        <p className="font-roboto text-lg text-blue-100 max-w-3xl leading-relaxed mb-8">
          ...
          Join divisions such as{" "}
          <strong>HART, Paramedics, and Air Ambulance</strong> to deliver life-saving care
